...
export default function DarkMode() {
    ...
    const toggleDarkMode = useCallback(() => {
      ...
      }, [currentTheme, darkMode, setTheme]);

    return (
        <div className="flex  flex-row justify-end w-full ">
            <div 
              className={`w-16 flex items-center ${darkMode ? 'justify-end bg-gray-800': ''} ease-in duration-300 px-1 h-8  rounded-2xl drop-shadow-lg bg-white scale-[0.9]`}
